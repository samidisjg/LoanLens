...
FEATURES_PATH = Path('artifacts/metadata/feature_columns.json')
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='Predict personal loan acceptance using the saved Random Forest model.')
